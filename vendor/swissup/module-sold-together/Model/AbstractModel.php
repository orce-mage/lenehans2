    ...
    implements EntityInterface, IdentityInterface
{
     ...
     * @param  int $relatedId
     * @param  int $storeId
     * @return \Swissup\SoldTogether\Model\AbstarctModel
     */
    public function loadRelation($productId, $relatedId, $storeId)
    {
        $this->setRelatedId($relatedId)->setStoreId($storeId);
    ...
    public function updateProductRelations($data, $productId, $productName)
    {
        ...
        foreach ($data as $item) {
            $this->setId(null)
                ...
                ->setIsAdmin(1)
                ->setWeight(static::MAX_WEIGHT - $item['position']);
            $this->save();
        }
