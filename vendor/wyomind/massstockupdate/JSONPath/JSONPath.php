...
class JSONPath implements ArrayAccess, Iterator, JsonSerializable, Countable
{
    ...
    public final function __construct(\Wyomind\MassStockUpdate\Helper\Delegate $wyomind, $data = [], bool $options = false)
    {
    ...
    {
        trigger_error('Calling JSONPath::data() is deprecated, please use JSONPath::getData() instead.', E_USER_DEPRECATED);
        return $this->getData();
    }
    /**
     * @return mixed|null
